...
dc.coordinateGridMixin = function (_chart) {
    ...
    //var _nullZoom = d3.behavior.zoom().on('zoom', null); //ASR EDIT
    var _nullZoom = function(){}; //ASR EDIT
...
dc.selectMenu = function (parent, chartGroup) {
    ...
    _chart._doRender = function () {
        ...
        //_select.append('option').text(_promptText).attr('value', ''); //ASR edit
	...
	var selector = $(_parent).children("div")[0];//ASR edit
	if (selector != null)
	{
	    selector = $(selector).children("select")[0];
